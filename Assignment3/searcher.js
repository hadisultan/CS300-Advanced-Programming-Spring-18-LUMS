...
Roll no: 2020-10-0065

Everything seems to be working fine. I've followed the inputs and formats
...
it'll create an index JSON file called 'myIndex.JSON' using the format
...
and will output the lines containing any of these words. Also "Ali" is
different from "Ali's" so if you want lines containing "Ali's" in your
output you'll have to add "Ali's" as an argument and not "Ali".
*/
